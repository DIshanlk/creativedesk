...
export default function AdminPanel() {
  ...
  // Guard
  useEffect(() => {
    if (currentUser && currentUser.role !== 'SuperAdmin') navigate('/', { replace: true });
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <aside className="w-52 bg-surface border-r border-border flex flex-col shrink-0">
        ...
        <div className="px-4 py-3 border-t border-border">
          <button onClick={() => navigate('/')} className="text-xs text-textMuted hover:text-primary flex items-center gap-1.5">
