                  ...
                  {allRequests.map(t => (
                    <tr key={t.id} className="hover:bg-background transition-colors">
                      <td className="px-4 py-3">
                        <Link to={`/task/${t.id}`} className="text-primary hover:underline font-mono text-xs">{t.key}</Link>
                      </td>
                      <td className="px-4 py-3 max-w-[260px]">
                        <Link to={`/task/${t.id}`} className="font-medium hover:text-primary truncate block">{t.title}</Link>
