                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <Link to={`/task/${task.id}`} className="font-mono text-xs text-textMuted hover:text-primary">{task.key}</Link>
                        ...
                        <Link to={`/task/${task.id}`} className="font-semibold text-sm mt-0.5 block hover:text-primary truncate">{task.title}</Link>
