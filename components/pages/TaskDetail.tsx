  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2 text-sm text-textMuted">
        ...
        <Link href="/list" className="hover:text-text">{task.space?.name || 'Tasks'}</Link>
        <span>/</span>
                  ...
                  return (
                    <div key={link.id} className="flex items-center justify-between text-xs group">
                      <div className="flex items-center gap-2">
                        ...
                        <Link href={`/task/${other?.id}`} className="font-mono text-primary hover:underline">{other?.key}</Link>
